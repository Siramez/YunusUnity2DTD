...
public class SprayTowerAttack : MonoBehaviour
{
    float nextFire;
    ...
    IEnumerator FireBullets()
    {
        ...
        {
            GameObject SprayBullet = Instantiate(bullet, ShootingPosition.position, Quaternion.identity);

            SprayBullet.GetComponent<SprayBullet>().damage = bulletDamage;
            SprayBullet.GetComponent<SprayBullet>().EnemyPosition = closestEnemyPostion;
