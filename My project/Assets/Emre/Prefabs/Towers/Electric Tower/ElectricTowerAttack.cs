...
public class ElectricTowerAttack : MonoBehaviour
{
    float nextFire;
    ...
    IEnumerator FireBullets()
    {
        for (int i = 0; i < bulletCount; i++)
        {
            ...
            EvolutionBullett.GetComponent<ElectricBullet>().damage = bulletDamage;
            EvolutionBullett.GetComponent<ElectricBullet>().EnemyPosition = closestEnemyPostion;
