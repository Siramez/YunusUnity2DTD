...
public class PoisonTowerAttack : MonoBehaviour
{
    float nextFire;
    ...
    IEnumerator FireBullets()
    {
        for (int i = 0; i < bulletCount; i++)
        {
            ...
            EvolutionBullett.GetComponent<PoisonBullet>().damage = bulletDamage;
            EvolutionBullett.GetComponent<PoisonBullet>().EnemyPosition = closestEnemyPostion;
